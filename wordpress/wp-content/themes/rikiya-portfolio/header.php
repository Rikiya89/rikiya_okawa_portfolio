<!DOCTYPE html>
<html lang="en,ja" <?php language_attributes(); ?>>
<head>
    <meta charset="<?php bloginfo('charset'); ?>">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta description="Welcome, my World!" />
    ...
    <div class="l-container">
        ...
        <nav class="nav">
            ...
            <ul class="navigation-list">
                ...
                <li class="list-item">
                    <a href="#digital_arts" class="nav-link">Digital Arts</a>
                </li>
                <li class="list-item">
                    <a href="#contact" class="nav-link">Contact</a>
                </li>
                <li class="list-item">
                    <a href="english-page.html" class="nav-link">English</a>
                </li>
            </ul>
